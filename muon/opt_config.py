...
import inspect
import os
from muon.adamuon import AdaMuon

def configure_optimizers(params, weight_decay, learning_rate, betas=(0.9, 0.95), device_type='cuda:3'):
    ...
    use_fused = fused_available and device_type == 'cuda:3'
