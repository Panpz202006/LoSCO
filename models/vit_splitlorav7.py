...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.rank = [14, 12, 11, 9, 8, 6, 6, 8, 9, 11, 12, 14]
        ...
        self.blocks = nn.Sequential(*[
            block_fn(
                ...
                init_values=init_values, drop_path=dpr[i], norm_layer=norm_layer, act_layer=act_layer, n_tasks=n_tasks, r=self.rank[i])
