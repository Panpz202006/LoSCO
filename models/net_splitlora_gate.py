...
from models.vit_splitlora_gate import VisionTransformer, PatchEmbed, Block, Attention_LoRA
from models.vit_splitlora_gate import resolve_pretrained_cfg, build_model_with_cfg, checkpoint_filter_fn
import torch
import torch.nn as nn

#splitlora也可以直接使用vitlora定义好的进行就OK了
# from models.vit_splitlora import VisionTransformer, PatchEmbed, Block, Attention_LoRA
# from models.vit_splitlora import resolve_pretrained_cfg, build_model_with_cfg, checkpoint_filter_fn
...
class Net(nn.Module):
    ...
    def forward(self, image, get_feat=False, get_cur_feat=False, fc_only=False):
        ...
        logits = []
        image_features = self.image_encoder(image, task_id=self._cur_task, get_feat=get_feat, get_cur_feat=get_cur_feat)
