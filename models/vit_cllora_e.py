...
class Attention_LoRA(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, scale=None, attn_drop=0., proj_drop=0., r=64, n_tasks=10,
        ...
        # task-shared LoRA (cross-task general knowledge, EMA-updated in *_e / *_o)
        self.Lora_shared_A_k = nn.Linear(dim, r, bias=False)  # [r, dim]
        self.Lora_shared_B_k = nn.Linear(r, dim, bias=False)  # [dim, r]
    ...
    def forward(self, x, task_id, blk_weight=None, use_new=False):
        ...
        # task-shared LoRA offsets (always added, EMA-updated as general knowledge)
        ...
        k = k + F.linear(x, shared_weight_k)
        v = v + F.linear(x, shared_weight_v)
